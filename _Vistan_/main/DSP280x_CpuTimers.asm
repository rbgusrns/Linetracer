...
DW$1	.dwtag  DW_TAG_subprogram, DW_AT_name("Sensor_Value"), DW_AT_symbol_name("_Sensor_Value")
	.dwattr DW$1, DW_AT_declaration(0x01)
	.dwattr DW$1, DW_AT_external(0x01)

DW$2	.dwtag  DW_TAG_subprogram, DW_AT_name("adc_timer_ISR"), DW_AT_symbol_name("_adc_timer_ISR")
...
;	..\Compiler\bin\opt2000.exe C:\Users\rbgus\AppData\Local\Temp\TI82810 C:\Users\rbgus\AppData\Local\Temp\TI8284 
;	..\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -I..\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\rbgus\AppData\Local\Temp\TI8282 --template_info_file C:\Users\rbgus\AppData\Local\Temp\TI8286 --object_file DSP280x_CpuTimers.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments --optimizer_interlist --program_level_compile 
	.sect	".text"
	.global	_InitCpuTimers

DW$12	.dwtag  DW_TAG_subprogram, DW_AT_name("InitCpuTimers"), DW_AT_symbol_name("_InitCpuTimers")
	.dwattr DW$12, DW_AT_low_pc(_InitCpuTimers)
	.dwattr DW$12, DW_AT_high_pc(0x00)
	.dwattr DW$12, DW_AT_begin_file("DSP280x_CpuTimers.c")
	.dwattr DW$12, DW_AT_begin_line(0x27)
	.dwattr DW$12, DW_AT_begin_column(0x06)
	.dwpsn	"DSP280x_CpuTimers.c",40,1
...
;***************************************************************
_InitCpuTimers:
;*** 43	-----------------------    CpuTimer0.RegsAddr = C$3 = &CpuTimer0Regs;
;*** 45	-----------------------    CpuTimer0Regs.PRD.all = 0xffffffffuL;
;*** 47	-----------------------    CpuTimer0Regs.TPR.all = 0u;
;*** 48	-----------------------    CpuTimer0Regs.TPRH.all = 0u;
;*** 50	-----------------------    *((volatile struct _TCR_BITS *)C$3+4L) |= 0x10u;
;*** 52	-----------------------    *(&CpuTimer0Regs+4L) |= 0x20u;
;*** 54	-----------------------    CpuTimer0.InterruptCount = 0uL;
;*** 58	-----------------------    CpuTimer1.RegsAddr = C$2 = &CpuTimer1Regs;
;*** 60	-----------------------    CpuTimer1Regs.PRD.all = 0xffffffffuL;
;*** 62	-----------------------    CpuTimer1Regs.TPR.all = 0u;
;*** 63	-----------------------    CpuTimer1Regs.TPRH.all = 0u;
;*** 65	-----------------------    *((volatile struct _TCR_BITS *)C$2+4L) |= 0x10u;
;*** 67	-----------------------    *(&CpuTimer1Regs+4L) |= 0x20u;
;*** 69	-----------------------    CpuTimer1.InterruptCount = 0uL;
;*** 73	-----------------------    CpuTimer2.RegsAddr = C$1 = &CpuTimer2Regs;
;*** 75	-----------------------    CpuTimer2Regs.PRD.all = 0xffffffffuL;
;*** 77	-----------------------    CpuTimer2Regs.TPR.all = 0u;
;*** 78	-----------------------    CpuTimer2Regs.TPRH.all = 0u;
;*** 80	-----------------------    *((volatile struct _TCR_BITS *)C$1+4L) |= 0x10u;
;*** 82	-----------------------    *(&CpuTimer2Regs+4L) |= 0x20u;
;*** 84	-----------------------    CpuTimer2.InterruptCount = 0uL;
;*** 84	-----------------------    return;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
...
;* AR4   assigned to C$2
DW$14	.dwtag  DW_TAG_variable, DW_AT_name("C$2"), DW_AT_symbol_name("C$2")
	.dwattr DW$14, DW_AT_type(*DW$T$33)
	.dwattr DW$14, DW_AT_location[DW_OP_reg12]
;* AR4   assigned to C$3
DW$15	.dwtag  DW_TAG_variable, DW_AT_name("C$3"), DW_AT_symbol_name("C$3")
	.dwattr DW$15, DW_AT_type(*DW$T$33)
	.dwattr DW$15, DW_AT_location[DW_OP_reg12]
	.dwpsn	"DSP280x_CpuTimers.c",43,2
        MOVL      XAR4,#_CpuTimer0Regs  ; |43| 
        MOVW      DP,#_CpuTimer0
        MOVL      @_CpuTimer0,XAR4      ; |43| 
	.dwpsn	"DSP280x_CpuTimers.c",45,2
        MOV       PH,#65535
        MOV       PL,#65535
        MOVW      DP,#_CpuTimer0Regs+2
        MOVL      @_CpuTimer0Regs+2,P   ; |45| 
	.dwpsn	"DSP280x_CpuTimers.c",47,2
        MOV       @_CpuTimer0Regs+6,#0  ; |47| 
	.dwpsn	"DSP280x_CpuTimers.c",48,2
        MOV       @_CpuTimer0Regs+7,#0  ; |48| 
	.dwpsn	"DSP280x_CpuTimers.c",50,2
        OR        *+XAR4[4],#0x0010     ; |50| 
	.dwpsn	"DSP280x_CpuTimers.c",52,2
        OR        @_CpuTimer0Regs+4,#0x0020 ; |52| 
	.dwpsn	"DSP280x_CpuTimers.c",54,2
        MOVB      ACC,#0
        MOVW      DP,#_CpuTimer0+2
        MOVL      @_CpuTimer0+2,ACC     ; |54| 
	.dwpsn	"DSP280x_CpuTimers.c",58,2
        MOVL      XAR4,#_CpuTimer1Regs  ; |58| 
        MOVL      @_CpuTimer1,XAR4      ; |58| 
	.dwpsn	"DSP280x_CpuTimers.c",60,2
        MOVW      DP,#_CpuTimer1Regs+2
        MOVL      @_CpuTimer1Regs+2,P   ; |60| 
	.dwpsn	"DSP280x_CpuTimers.c",62,2
        MOV       @_CpuTimer1Regs+6,#0  ; |62| 
	.dwpsn	"DSP280x_CpuTimers.c",63,2
        MOV       @_CpuTimer1Regs+7,#0  ; |63| 
	.dwpsn	"DSP280x_CpuTimers.c",65,2
        OR        *+XAR4[4],#0x0010     ; |65| 
	.dwpsn	"DSP280x_CpuTimers.c",67,2
        OR        @_CpuTimer1Regs+4,#0x0020 ; |67| 
	.dwpsn	"DSP280x_CpuTimers.c",69,2
        MOVB      ACC,#0
        MOVW      DP,#_CpuTimer1+2
        MOVL      @_CpuTimer1+2,ACC     ; |69| 
	.dwpsn	"DSP280x_CpuTimers.c",73,2
        MOVL      XAR4,#_CpuTimer2Regs  ; |73| 
        MOVL      @_CpuTimer2,XAR4      ; |73| 
	.dwpsn	"DSP280x_CpuTimers.c",75,2
        MOVW      DP,#_CpuTimer2Regs+2
        MOVL      @_CpuTimer2Regs+2,P   ; |75| 
	.dwpsn	"DSP280x_CpuTimers.c",77,2
        MOV       @_CpuTimer2Regs+6,#0  ; |77| 
	.dwpsn	"DSP280x_CpuTimers.c",78,2
        MOV       @_CpuTimer2Regs+7,#0  ; |78| 
	.dwpsn	"DSP280x_CpuTimers.c",80,2
        OR        *+XAR4[4],#0x0010     ; |80| 
	.dwpsn	"DSP280x_CpuTimers.c",82,2
        OR        @_CpuTimer2Regs+4,#0x0020 ; |82| 
	.dwpsn	"DSP280x_CpuTimers.c",84,2
        MOVB      ACC,#0
        MOVW      DP,#_CpuTimer2+2
        MOVL      @_CpuTimer2+2,ACC     ; |84| 
	.dwpsn	"DSP280x_CpuTimers.c",85,1
        LRETR
        ; return occurs
	.dwattr DW$12, DW_AT_end_file("DSP280x_CpuTimers.c")
	.dwattr DW$12, DW_AT_end_line(0x55)
...
DW$16	.dwtag  DW_TAG_subprogram, DW_AT_name("ConfigCpuTimer"), DW_AT_symbol_name("_ConfigCpuTimer")
	.dwattr DW$16, DW_AT_low_pc(_ConfigCpuTimer)
	.dwattr DW$16, DW_AT_high_pc(0x00)
	.dwattr DW$16, DW_AT_begin_file("DSP280x_CpuTimers.c")
	.dwattr DW$16, DW_AT_begin_line(0x5f)
	.dwattr DW$16, DW_AT_begin_column(0x06)
	.dwpsn	"DSP280x_CpuTimers.c",96,1
...
;***************************************************************
_ConfigCpuTimer:
;*** 100	-----------------------    (*Timer).CPUFreqInMHz = Freq;
;*** 101	-----------------------    (*Timer).PeriodInUSec = Period;
;*** 103	-----------------------    (*(*Timer).RegsAddr).PRD.all = (long)(Freq*Period);
;*** 106	-----------------------    (*(*Timer).RegsAddr).TPR.all = 0u;
;*** 107	-----------------------    (*(*Timer).RegsAddr).TPRH.all = 0u;
;*** 110	-----------------------    *((volatile struct _TCR_BITS *)(*Timer).RegsAddr+4L) |= 0x10u;
;*** 111	-----------------------    *((volatile struct _TCR_BITS *)(*Timer).RegsAddr+4L) |= 0x20u;
;*** 112	-----------------------    *((volatile struct _TCR_BITS *)(*Timer).RegsAddr+4L) |= 0x400u;
;*** 113	-----------------------    *((volatile struct _TCR_BITS *)(*Timer).RegsAddr+4L) |= 0x800u;
;*** 114	-----------------------    *((volatile struct _TCR_BITS *)(*Timer).RegsAddr+4L) |= 0x4000u;
;*** 117	-----------------------    (*Timer).InterruptCount = 0uL;
;*** 117	-----------------------    return;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
...
DW$17	.dwtag  DW_TAG_formal_parameter, DW_AT_name("Timer"), DW_AT_symbol_name("_Timer")
	.dwattr DW$17, DW_AT_type(*DW$T$48)
	.dwattr DW$17, DW_AT_location[DW_OP_reg12]
;* AL    assigned to _Freq
DW$18	.dwtag  DW_TAG_formal_parameter, DW_AT_name("Freq"), DW_AT_symbol_name("_Freq")
	.dwattr DW$18, DW_AT_type(*DW$T$16)
	.dwattr DW$18, DW_AT_location[DW_OP_reg0]
DW$19	.dwtag  DW_TAG_formal_parameter, DW_AT_name("Period"), DW_AT_symbol_name("_Period")
	.dwattr DW$19, DW_AT_type(*DW$T$16)
	.dwattr DW$19, DW_AT_location[DW_OP_breg20 -8]
;* AR1   assigned to _Timer
DW$20	.dwtag  DW_TAG_variable, DW_AT_name("Timer"), DW_AT_symbol_name("_Timer")
	.dwattr DW$20, DW_AT_type(*DW$T$69)
	.dwattr DW$20, DW_AT_location[DW_OP_reg6]
;* AL    assigned to _Freq
DW$21	.dwtag  DW_TAG_variable, DW_AT_name("Freq"), DW_AT_symbol_name("_Freq")
	.dwattr DW$21, DW_AT_type(*DW$T$54)
	.dwattr DW$21, DW_AT_location[DW_OP_reg0]
;* AR6   assigned to _Period
DW$22	.dwtag  DW_TAG_variable, DW_AT_name("Period"), DW_AT_symbol_name("_Period")
	.dwattr DW$22, DW_AT_type(*DW$T$54)
	.dwattr DW$22, DW_AT_location[DW_OP_reg16]
        MOVL      XAR1,XAR4             ; |96| 
        MOVL      XAR6,*-SP[8]          ; |96| 
	.dwpsn	"DSP280x_CpuTimers.c",100,2
        MOVL      *+XAR1[4],ACC         ; |100| 
	.dwpsn	"DSP280x_CpuTimers.c",101,2
        MOVL      *+XAR1[6],XAR6        ; |101| 
	.dwpsn	"DSP280x_CpuTimers.c",103,2
        MOVL      *-SP[2],XAR6          ; |103| 
        LCR       #FS$$MPY              ; |103| 
        ; call occurs [#FS$$MPY] ; |103| 
        LCR       #FS$$TOL              ; |103| 
        ; call occurs [#FS$$TOL] ; |103| 
        MOVL      XAR4,*+XAR1[0]        ; |103| 
        MOVL      *+XAR4[2],ACC         ; |103| 
	.dwpsn	"DSP280x_CpuTimers.c",106,2
        MOVL      XAR4,*+XAR1[0]        ; |106| 
        MOV       *+XAR4[6],#0          ; |106| 
	.dwpsn	"DSP280x_CpuTimers.c",107,2
        MOVL      XAR4,*+XAR1[0]        ; |107| 
        MOV       *+XAR4[7],#0          ; |107| 
	.dwpsn	"DSP280x_CpuTimers.c",110,2
        MOVL      XAR4,*+XAR1[0]        ; |110| 
        OR        *+XAR4[4],#0x0010     ; |110| 
	.dwpsn	"DSP280x_CpuTimers.c",111,2
        MOVL      XAR4,*+XAR1[0]        ; |111| 
        OR        *+XAR4[4],#0x0020     ; |111| 
	.dwpsn	"DSP280x_CpuTimers.c",112,2
        MOVL      XAR4,*+XAR1[0]        ; |112| 
        OR        *+XAR4[4],#0x0400     ; |112| 
	.dwpsn	"DSP280x_CpuTimers.c",113,2
        MOVL      XAR4,*+XAR1[0]        ; |113| 
        OR        *+XAR4[4],#0x0800     ; |113| 
	.dwpsn	"DSP280x_CpuTimers.c",114,2
        MOVL      XAR4,*+XAR1[0]        ; |114| 
        OR        *+XAR4[4],#0x4000     ; |114| 
	.dwpsn	"DSP280x_CpuTimers.c",117,2
        MOVB      ACC,#0
        MOVL      *+XAR1[2],ACC         ; |117| 
	.dwpsn	"DSP280x_CpuTimers.c",119,1
        SUBB      SP,#2
	.dwcfa	0x1d, -4
        MOVL      XAR1,*--SP
	.dwcfa	0x1d, -2
	.dwcfa	0xc0, 7
        LRETR
        ; return occurs
	.dwattr DW$16, DW_AT_end_file("DSP280x_CpuTimers.c")
	.dwattr DW$16, DW_AT_end_line(0x77)
...
;*** 145	-----------------------    asm(" setc INTM");
;*** 147	-----------------------    InitCpuTimers();
;*** 149	-----------------------    *(&PieCtrlRegs+2L) |= 0x40u;
;*** 150	-----------------------    *(&PieCtrlRegs+2L) |= 0x20u;
;*** 152	-----------------------    asm(" EALLOW");
;*** 154	-----------------------    PieVectTable.TINT0 = &Sensor_Value;
;*** 155	-----------------------    PieVectTable.XINT13 = &motor_ISR;
;*** 156	-----------------------    PieVectTable.ADCINT = &adc_timer_ISR;
;*** 158	-----------------------    asm(" EDIS");
;*** 160	-----------------------    IER |= 0x3001u;
;*** 162	-----------------------    ConfigCpuTimer(&CpuTimer0, 100.0F, 25.0F);
;*** 163	-----------------------    ConfigCpuTimer(&CpuTimer1, 100.0F, 500.0F);
;*** 165	-----------------------    asm(" clrc INTM");
;*** 166	-----------------------    asm(" clrc DBGM");
;*** 166	-----------------------    return;
	.dwcfa	0x1d, -2
	...
	.dwcfa	0x09, 40, 26
        ADDB      SP,#2
	.dwcfa	0x1d, -4
	.dwpsn	"DSP280x_CpuTimers.c",145,1
 setc INTM
	.dwpsn	"DSP280x_CpuTimers.c",147,3
        SPM       #0
        LCR       #_InitCpuTimers       ; |147| 
        ; call occurs [#_InitCpuTimers] ; |147| 
	.dwpsn	"DSP280x_CpuTimers.c",149,3
        MOVW      DP,#_PieCtrlRegs+2
        OR        @_PieCtrlRegs+2,#0x0040 ; |149| 
	.dwpsn	"DSP280x_CpuTimers.c",150,3
        OR        @_PieCtrlRegs+2,#0x0020 ; |150| 
	.dwpsn	"DSP280x_CpuTimers.c",152,3
 EALLOW
	.dwpsn	"DSP280x_CpuTimers.c",154,3
        MOVL      XAR4,#_Sensor_Value   ; |154| 
        MOVW      DP,#_PieVectTable+76
        MOVL      @_PieVectTable+76,XAR4 ; |154| 
	.dwpsn	"DSP280x_CpuTimers.c",155,3
        MOVW      DP,#_PieVectTable+26
        MOVL      XAR4,#_motor_ISR      ; |155| 
        MOVL      @_PieVectTable+26,XAR4 ; |155| 
	.dwpsn	"DSP280x_CpuTimers.c",156,3
        MOVW      DP,#_PieVectTable+74
        MOVL      XAR4,#_adc_timer_ISR  ; |156| 
        MOVL      @_PieVectTable+74,XAR4 ; |156| 
	.dwpsn	"DSP280x_CpuTimers.c",158,3
 EDIS
	.dwpsn	"DSP280x_CpuTimers.c",160,3
        OR        IER,#0x3001           ; |160| 
	.dwpsn	"DSP280x_CpuTimers.c",162,3
        MOV       AL,#0
        MOV       AH,#16840
        MOVL      *-SP[2],ACC           ; |162| 
        SPM       #0
        MOVL      XAR4,#_CpuTimer0      ; |162| 
        MOV       AH,#17096
        LCR       #_ConfigCpuTimer      ; |162| 
        ; call occurs [#_ConfigCpuTimer] ; |162| 
	.dwpsn	"DSP280x_CpuTimers.c",163,3
        MOV       AL,#0
        MOV       AH,#17402
        MOVL      *-SP[2],ACC           ; |163| 
        MOVL      XAR4,#_CpuTimer1      ; |163| 
        MOV       AH,#17096
        LCR       #_ConfigCpuTimer      ; |163| 
        ; call occurs [#_ConfigCpuTimer] ; |163| 
	.dwpsn	"DSP280x_CpuTimers.c",165,3
 clrc INTM
	.dwpsn	"DSP280x_CpuTimers.c",166,3
 clrc DBGM
	.dwpsn	"DSP280x_CpuTimers.c",170,1
        SUBB      SP,#2
	.dwcfa	0x1d, -2
        SPM       #0
        LRETR
	...
	.dwattr DW$23, DW_AT_end_line(0xaa)
