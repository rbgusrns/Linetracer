...
;* Date/Time created: Tue Jul 29 01:52:22 2025                 *
;***************************************************************
...
;	..\Compiler\bin\opt2000.exe C:\Users\rbgus\AppData\Local\Temp\TI64810 C:\Users\rbgus\AppData\Local\Temp\TI6484 
;	..\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -I..\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\rbgus\AppData\Local\Temp\TI6482 --template_info_file C:\Users\rbgus\AppData\Local\Temp\TI6486 --object_file DSP280x_MemCopy.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments --optimizer_interlist --program_level_compile 
	.sect	".text"
	.global	_MemCopy
...
DW$9	.dwtag  DW_TAG_loop
	.dwattr DW$9, DW_AT_name("C:\project\Linetracer\_Vistan_\main\DSP280x_MemCopy.asm:L1:1:1753721542")
