...
;* Date/Time created: Sat Aug 16 02:43:32 2025                 *
;***************************************************************
...
;	..\Compiler\bin\opt2000.exe C:\Users\rbgus\AppData\Local\Temp\TI61610 C:\Users\rbgus\AppData\Local\Temp\TI6164 
;	..\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -I..\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\rbgus\AppData\Local\Temp\TI6162 --template_info_file C:\Users\rbgus\AppData\Local\Temp\TI6166 --object_file DSP280x_MemCopy.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments --optimizer_interlist --program_level_compile 
	.sect	".text"
	.global	_MemCopy
...
DW$9	.dwtag  DW_TAG_loop
	.dwattr DW$9, DW_AT_name("C:\project\Linetracer\_Vistan_\main\DSP280x_MemCopy.asm:L1:1:1755279812")
