...
;* Date/Time created: Mon Jun 23 23:51:24 2025                 *
;***************************************************************
...
;	C:\project\monitor_2809\Compiler\bin\opt2000.exe C:\Users\rbgus\AppData\Local\Temp\TI48810 C:\Users\rbgus\AppData\Local\Temp\TI4884 
;	C:\project\monitor_2809\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -IC:\project\monitor_2809\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\rbgus\AppData\Local\Temp\TI4882 --template_info_file C:\Users\rbgus\AppData\Local\Temp\TI4886 --object_file DSP280x_MemCopy.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments 
	.sect	".text"
	.global	_MemCopy
...
DW$9	.dwtag  DW_TAG_loop
	.dwattr DW$9, DW_AT_name("C:\project\monitor_2809\main\DSP280x_MemCopy.asm:L1:1:1750690284")
